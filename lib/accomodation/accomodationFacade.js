...
// Get Home Category
function getHomeCategory(req) {
    return amdService.getHomeCategory(req).then((result) => result)
}
...
function getNearByMostSearch(req) {
    return amdService.getNearByMostSearch(req).then((result) => result)
}

function getDastination (req) {
    return amdService.getDastination(req).then((result) => result)
}
module.exports = {
    addAccomodation,
    listAccomodation,
