...
amdRouter.route('/searchPropartyList/:page').post((req, res) => {
    amdFacade.searchnFilterHomeOffice(req).then(result => {
        res.send(result)
    }).catch(err => {
        console.log(err)
...
amdRouter.route('/getNearByResentlySearch').post((req, res) => {
    amdFacade.getNearByMostSearch(req).then(result => {
        res.send(result)
    }).catch(err => {
        console.log(err)
        res.send(mapper.responseMapping(amdConstants.CODE.badrequest, amdConstants.MESSAGE.intrnlSrvrErr))
...
amdRouter.route('/getDastination').get((req, res) => {
    amdFacade.getDastination(req).then(result => {
        res.send(result)
    }).catch(err => {
        console.log(err)
        res.send(mapper.responseMapping(amdConstants.CODE.badrequest, amdConstants.MESSAGE.intrnlSrvrErr))
